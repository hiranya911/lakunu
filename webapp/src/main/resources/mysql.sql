...
CREATE TABLE evaluation (
  id BIGINT PRIMARY KEY NOT NULL AUTO_INCREMENT,
  submission_id BIGINT NOT NULL REFERENCES submission(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE grade (
  id BIGINT PRIMARY KEY NOT NULL AUTO_INCREMENT,
  evaluation_id BIGINT NOT NULL REFERENCES evaluation(id) ON DELETE CASCADE ON UPDATE CASCADE,
  label VARCHAR(128) NOT NULL,
  score DOUBLE NOT NULL,
  score_limit DOUBLE NOT NULL DEFAULT 0
);